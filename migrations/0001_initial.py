# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-19 07:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='lab_reservation_tools.User')),
        ...
        migrations.AddField(
            model_name='user',
            name='reservations',
            field=models.ManyToManyField(through='lab_reservation_tools.Reservation', to='lab_reservation_tools.Host'),
        ),
        migrations.AddField(
